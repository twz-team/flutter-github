...
User _$UserBeanFromJson(Map<String, dynamic> json) {
  return User(
    ...
    ..organizationsUrl = json['origanizations_url'] as String
...
Map<String, dynamic> _$UserBeanToJson(User instance) => <String, dynamic>{
      ...
      'origanizations_url': instance.organizationsUrl,
...
UserPlanBean _$UserPlanBeanFromJson(Map<String, dynamic> json) {
  return UserPlanBean()
    ..name = json['name'] as String
...
Map<String, dynamic> _$UserPlanBeanToJson(UserPlanBean instance) =>
    <String, dynamic>{
      'name': instance.name,
